...
1. Updated `linalg-traits` dependency from `0.9.1` to `0.14.0`.
1. Updated `nalgebra` optional dependency from `0.33.0` to `0.34.1`.
1. Updated `ndarray` optional dependency from `0.16.0` to `0.17.2`.
1. Updated `rootfinder` dependency from `0.3.0` to `0.5.1`.
1. Updated `numtest` dev dependency from `0.1.6` to `0.4.1`.
1. Added `faer` optional dependency at `0.24.0`.
1. Added `faer-traits` optional dependency at `0.24.0`.
